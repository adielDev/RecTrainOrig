...
public class LooperHanderEx1 extends Activity implements View.OnClickListener, Handler.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDGThread = new DataGenThread("DataGen bg thread");
        mDGThread.start();
    }
    ...
    private void doGenerate() {
        ...
        for (int i = 0; i < dataBuf.length; i++) {
            ...
            if ((i % progScale) == 0) {
                mHandler.obtainMessage(MSG_PROG_UPDATE,
                        (i / progScale),
                        0).sendToTarget();
            }
        }
